            ...
            <dl class="content">
                ...
                <dd id="btn-dd">
						<span class="new-btn-login-sp">
							<button class="new-btn-login" name="pay" id="pay" type="submit"
...
<script language="javascript">
    ...
    function GetDateNow() {
        ...
        document.getElementById("WIDsubject").value = "图像隐写在线服务平台资源	下载支付";
